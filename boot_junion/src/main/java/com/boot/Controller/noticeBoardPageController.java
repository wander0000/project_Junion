...
//	@RequestMapping("/listWithPaging")
	...
	public String listWithPaging(Criteria cri, Model model,  noticeBoardBoardDTO boardDTO, HttpServletRequest httpServletRequest) {  // listWithPaging = 'list'로 담아서넘김 / getTotalCount + PageDTO = 'pageMaker'로 담아서넘김
		log.info("@# list");
		log.info("@# cri=>"+cri);
