...
//		log.info("std.getPageNum()@@@  -> "+std.getAmount());
//		log.info("std.getAmount()@@@  -> "+std.getAmount());
//		log.info("this.realEnd@@@  -> "+realEnd);
		if (realEnd <= this.endpage) {
			this.endpage = realEnd;
		}
		
//		log.info("this.startpage@@@  -> "+startpage);
//		log.info("this.endpage@@@  -> "+endpage);
