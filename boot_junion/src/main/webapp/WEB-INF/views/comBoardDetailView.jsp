...
<title>게시판 상세페이지</title>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/com_board_detail.css">
...
<body>
	...
	<!-- 섹션-->
	        <section> 
	            <div class="wrap">     
	                <div class="board">
						<form id="boardForm" method="post" action="comBoardModifyView">  <!--  폼 시작 -->
							
							<input type='hidden' name='com_email' id='com_email' value='${login_email}'>
		                    ...
		                    <div class="namebox">
		                        <h5 class="name">
		                            ${boardDetailView.com_email} ${boardDetailView.board_no}번째글
		                        </h5>
		                    </div> <!-- 네임 끝 -->
		                    <div class="lastline">
		                        <div class="line1">
		                        ...
		                        <div class="line2">
		                            ...
		                            <div class="rightb2box">
		                                <div>
		                                    <h5 class="r2">
												<span >
													<a href="#" onclick="clip(); return false;" class="r22">
														URL복사
													</a>
												</span>
		                                    </h5>
			                ...
			                <div class="buttonbox">
								...
								<button type="button" class="button" onclick="validateAndSubmit('comBoardModifyView')">
									<h5 class="but1">수정</h5>
								</button>
			
								<button type="button" class="button" onclick="validateAndSubmit('comBoardDelete')">
									<h5 class="but2">삭제</h5>
								</button>
			
			                    <button type="submit" formaction="comBoardList" class="button">
									<h5 class="but2">목록</h5>
								</button>
...
<script>
	...
	// 댓글스크립트 시작 //
const commentWrite = () => {
    const email = document.getElementById("com_email").value;
    ...
    $.ajax({
        ...
        url: "/comBoardComment/comBoardSave",
        success: function() {
            console.log("작성성공");
            // 페이지 새로 고침
            location.reload();
...
$(document).ready(function () {  
    ...
    (function() {
        ...
        $.getJSON("/compGetFileList", {board_no: board_no}, function (arr) {
            console.log("@# arr=>" + arr);
	...
	function validateAndSubmit(action) {
		const com_email = document.getElementById("com_email").value;
		const authorEmail = "${boardDetailView.com_email}";

		if (com_email !== authorEmail) {
			alert("작성자만 수정 및 삭제할 수 있습니다.");
			return;
		}
		if (action === 'comBoardDelete') {
    ...
    $('#likeButton').on('click', function (e) {
        ...
        $.ajax({
            type: "POST",
            url: "${pageContext.request.contextPath}/comBoardLike",
            data: {
                board_no: board_no,
                com_email: com_email
            },
