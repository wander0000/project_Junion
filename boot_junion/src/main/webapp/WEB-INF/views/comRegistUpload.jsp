                ...
                <form id="registUpload" method="post" action="registerNotice" class="post" name="notice">
                    ...
                    <div class="postContainer">
                        <div class="postValue">
                            ...
                            <input type="text" class="postTitle" name="notice_title" placeholder="공고명을 입력해주세요.">
                        </div>
                        <div class="postValue">
                        ...
                        <div class="postValue">
                            ...
                            <input type="text" class="postPosition" name="notice_job" placeholder="모집하는 포지션을 입력해주세요.">
                        </div>

                        <div class="postValue">
                            <h5 class="value">모집 인원 </h5>
                            <span>
                                <input type="number" class="people" name="notice_recruitNum" placeholder="모집 인원을 숫자만 입력해주세요.">
                            </span>
                        </div>
